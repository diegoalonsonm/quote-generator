...
async function UpdateQuoteDDBObject() {
    ...
    try {
        ...
        console.log('error updating quote object', err);
    }
}
    ...
    async function getRandomQuote(apiURLInput) {
        ...
        const svgImage = `
          <svg width="${width}" height="${heigth}">
            ...
            <text x="${width / 2}" y="${heigth - 10}" class="footerStyles">
              Developed by @diegoalonsonm | Quotes from ZenQuotes.io
            </text>
          </svg>
        `;
        ...
        const backgroundImages = [
          "backgrounds/Bighead.jpg",
          "backgrounds/Dawn.jpg",
        ...
        try {
            ...
            console.log('error updating dynamo db', err);
        }
